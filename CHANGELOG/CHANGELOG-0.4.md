...
- Add command line arguments `leader-election-lease-duration`, `leader-election-renew-deadline`, and `leader-election-retry-period` to configure leader election options for the external health monitor controller ([#90](https://github.com/kubernetes-csi/external-health-monitor/pull/90), [@deepakkinni](https://github.com/deepakkinni))

### Other (Cleanup or Flake)

- Remove the deployment file of external-health-monitor-agent ([#68](https://github.com/kubernetes-csi/external-health-monitor/pull/68), [@fengzixu](https://github.com/fengzixu))
- Updates container-storage-interface dependency to v1.5.0 ([#77](https://github.com/kubernetes-csi/external-health-monitor/pull/77), [@chrishenzie](https://github.com/chrishenzie))
- Updates Kubernetes dependencies to v1.22.0 ([#84](https://github.com/kubernetes-csi/external-health-monitor/pull/84), [@chrishenzie](https://github.com/chrishenzie)) [SIG Storage]
- Updates csi-lib-utils dependency to v0.10.0 ([#85](https://github.com/kubernetes-csi/external-health-monitor/pull/85), [@chrishenzie](https://github.com/chrishenzie))
